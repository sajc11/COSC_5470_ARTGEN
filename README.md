...
* **Music Spectrograms:** Generated from various audio tracks for training the CNN model.
  ...
  * Additionally, the spectrograph dataset, entitled ```spectrograms```, and corresponding metadata csv, ```song_metadata.csv``` can be found within the ```resources``` folder of this github.
